package com.deividsantos.trabalhoii.graphs.bfs;

import com.deividsantos.trabalhoii.GraphBuilder;
import com.deividsantos.trabalhoii.graphs.Graph;
import com.deividsantos.trabalhoii.graphs.In;
import com.deividsantos.trabalhoii.graphs.Stack;
import com.deividsantos.trabalhoii.graphs.StdOut;
...
public class BreadthFirstPaths {
    ...
    public static void main(String[] args) {
        In in = new In(args[0]);
        List<String> warText = Arrays.asList(in.readAllLines());
        ...
        int roadsNumber = Integer.valueOf(firstLine[ROADS_INDEX]);

        Graph G = GraphBuilder.createGraph(warText, nearbyCastlesNumber);
