...
public class FloydWarshall {
    ...
    /**
     * Calcula uma arvore de caminhos mais curtos de todos os vertices para todos os vertices
     * em um digrafo valorado {@code G}. Se houver um ciclo negativo, seta a flag e retorna.
    ...
    public long tempoTotal() { return endTime - startTime; }

    /**
     * Tem ciclo negativo?
     * @return {@code true} se existe um ciclo negativo, e {@code false} caso não exista
     */
    ...
    /**
     * Retorna o comprimento do caminho mais curto do vertice {@code s} ao vertice {@code t}.
     * @param  s o vertice de origem
     * @param  t o vertice de destino
...
//    // Retorna caminho entre u e v (lista de vertices)
//    procedure Path(u, v)
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for (int v = 0; v < G.V(); v++) {
            StdOut.printf("%3d: ", v);
            for (int w = 0; w < G.V(); w++) {
                if (spt.temCaminho(v, w)) StdOut.printf("%6.2f ", spt.dist(v, w));
