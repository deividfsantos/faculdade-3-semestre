...
//        List<String> programa = reader.readFile(path);
        //for (int i = 0; i < programa.size(); i++) {
            ...
            final Integer endereco = muxPC(blocoControle, valorUla);// Guarda a saida do multiplexador entre pc e o bloco de memoria
            final Integer registradorDadosMemoria = memoria.ler(endereco, blocoControle);// Guarda a saida da leitura da memoria
    ...
    //ToString do bloco de registradores
